...
import { Sparkles, Download, RefreshCw, Copy, Check, Wand2, Image as ImageIcon, AlertCircle, Trash2 } from "lucide-react";
...
export default function Generate() {
  ...
  const handleDownload = async (imageUrl, prompt) => {
    try {
      ...
      link.href = url;
      link.download = `flik_${prompt.slice(0, 30).replace(/\s+/g, '_')}.png`;
          ...
          >
            ...
            <div className="mt-6 flex justify-between items-center">
              <div className="text-xs text-white/40">
                Tip: Press {navigator.platform.includes('Mac') ? 'Cmd' : 'Ctrl'}+Enter to generate
              </div>
              <Button

        ...
        <AnimatePresence>
          {isRecording && (
            <motion.div
              ...
              exit={{ opacity: 0 }}
              className="absolute top-20 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-black/60 backdrop-blur-md rounded-full px-4 py-1.5 z-30"
            >
              <motion.div

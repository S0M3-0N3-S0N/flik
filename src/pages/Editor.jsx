    ...
    <div className="h-[calc(100dvh-4rem)] flex flex-col lg:flex-row overflow-hidden">
      ...
      >
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="flex overflow-x-auto no-scrollbar lg:grid lg:grid-cols-8 bg-white/5 mx-2 my-2 p-1 rounded-xl h-10 lg:h-auto gap-1 lg:gap-0 flex-shrink-0">

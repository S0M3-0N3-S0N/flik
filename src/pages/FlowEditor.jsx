...
import {
  ...
  Controls,
  BackgroundVariant,
  ReactFlowProvider } from
"@xyflow/react";
import "@xyflow/react/dist/style.css";
import { motion, AnimatePresence } from "framer-motion";
import {
  Play, Trash2, Loader2, Image, Wand2, Download, Sparkles,
  FileText, ArrowLeft, RotateCcw, X, CheckCircle2, Plus } from
"lucide-react";
import { useNavigate } from "react-router-dom";
import { createPageUrl } from "@/utils";
import { base44 } from "@/api/base44Client";
import {
  ImageInputNode, MagicBrushNode, ImagineAINode, BlankNode, OutputNode } from
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <aside className="flex-shrink-0 w-52 border-r border-white/5 flex flex-col gap-1 p-3 overflow-y-auto hidden md:flex" style={{ background: "#0c0c0c" }}>
          ...
          style={{ background: "rgba(255,255,255,0.025)" }}>
              <div className="mt-0.5 opacity-100 rounded-lg w-7 h-7 flex items-center justify-center flex-shrink-0" style={{ background: `${color}20` }}>

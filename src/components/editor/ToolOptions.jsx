...
export const FLASH_OPTIONS = [
  { id: "flash_white", label: "White Flash", icon: Zap, prompt: "Relight this exact photo with a powerful direct on-camera white flash: the subject's face and front-facing surfaces are brightly overexposed with harsh white light, skin looks slightly washed out from the flash intensity, eyes may show slight red-eye, the background drops off sharply into deep darkness due to flash falloff, colors are saturated and vivid under the direct flash, the image has that raw authentic disposable camera or paparazzi flash look. Keep all original details — only change the lighting." },
  { id: "flash_golden", label: "Golden Flash", icon: Sun, prompt: "Relight this exact photo with a warm amber-gold gel flash: the subject is bathed in rich warm golden light as if a professional photographer used a gold gel over the flash, skin tones glow with warm honey and amber tones, highlights are slightly overexposed in gold, shadows behind the subject are deep and dark, the overall mood is luxurious and editorial. Keep all original details — only change the lighting." },
  { id: "flash_blue", label: "Blue Flash", icon: Droplets, prompt: "Relight this exact photo with an icy blue gel flash: the subject is hit with a sharp cool blue-tinted flash, skin appears with a cold cyan-blue cast, overexposed highlights are crisp white-blue, background falls into dark blue-black shadows, the aesthetic is high-fashion editorial or cyberpunk nightlife. Keep all original details — only change the lighting." },
  { id: "flash_pink", label: "Pink Flash", icon: Sparkles, prompt: "Relight this exact photo with a vibrant pink/magenta gel flash: the subject glows under intense pink-magenta direct flash light, skin has a warm rosy-pink tint, highlights are blown out in hot pink, the background is dark with pink fringing, the vibe is Y2K party photography or fashion editorial. Keep all original details — only change the lighting." },
  { id: "flash_red", label: "Red Flash", icon: Flame, prompt: "Relight this exact photo with a dramatic red gel flash: the subject is hit with intense red flash light, skin and surfaces take on a deep red-crimson tint, overexposed areas are vivid red, background is near-black, the look is high-contrast and cinematic as if shot with a red theatrical gel. Keep all original details — only change the lighting." },
  { id: "flash_green", label: "Green Flash", icon: Leaf, prompt: "Relight this exact photo with an electric neon-green gel flash: the subject is illuminated by harsh neon-green direct flash, skin takes on an eerie green tint, highlights are blown out in bright lime-green, background is dark with green falloff, the aesthetic is rave photography, horror, or cyberpunk. Keep all original details — only change the lighting." },
  { id: "flash_purple", label: "Purple Flash", icon: Moon, prompt: "Relight this exact photo with a deep violet-purple gel flash: the subject is bathed in rich purple flash light, skin has a violet undertone, overexposed highlights glow in soft lavender-purple, the background is dark and moody, the look is editorial high-fashion or nightclub photography. Keep all original details — only change the lighting." },
  { id: "flash_strobe", label: "Strobe", icon: Zap, prompt: "Apply a dramatic stroboscopic multi-flash effect to this photo: create 2-3 ghosted motion echoes of the subject as if captured by a strobe light, each echo slightly offset and fading in opacity, harsh white strobe highlights, pitch-black background, freeze-motion nightclub or concert strobe photography aesthetic. Keep the main subject sharp." },
];

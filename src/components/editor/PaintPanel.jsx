...
const COLOR_FAMILIES = [
  // ❤️ Reds
  ["#1A0000","#2D0000","#3D0000","#660000","#8B0000","#B22222","#CC0000","#E50000","#FF0000","#FF3333","#FF6666","#FF9999","#FFCCCC"],
  // 🟧 Red-Oranges
  ["#1F0700","#3A0E00","#4D1100","#7A1A00","#A02000","#C83200","#E84400","#FF4500","#FF6622","#FF8855","#FFAA88","#FFCCBB"],
  // 🟠 Oranges
  ["#180A00","#2B1200","#3D1A00","#6B2E00","#994400","#CC5500","#E56600","#FF6600","#FF8800","#FFAA33","#FFCC77","#FFEEBB"],
  // 🟡 Yellow-Oranges
  ["#1F1400","#332000","#4D3300","#7A5000","#A07000","#CC9000","#E5AA00","#FFC000","#FFD000","#FFE033","#FFEE88","#FFF5CC"],
  // 💛 Yellows
  ["#1A1A00","#2B2B00","#3D3D00","#6B6B00","#999900","#CCCC00","#E5E500","#FFFF00","#FFFF33","#FFFF77","#FFFFAA","#FFFFDD"],
  // 🟢 Yellow-Greens
  ["#0A1500","#121E00","#1E3300","#3A5C00","#558000","#70AA00","#88CC00","#AAEE00","#BBFF00","#CCFF44","#DDFF88","#EEFFBB"],
  // 🟢 Greens
  ["#001100","#002200","#003300","#005500","#007700","#009900","#00BB00","#00CC00","#00EE00","#33FF33","#77FF77","#AAFFAA","#DDFFDD"],
  // 🌿 Blue-Greens / Teals
  ["#00110A","#001F12","#002B1A","#004D33","#007755","#009966","#00BB88","#00CCAA","#00EEBB","#33FFCC","#77FFDD","#AAFFF0"],
  // 🩵 Cyans
  ["#001414","#002222","#003333","#005555","#007777","#009999","#00BBBB","#00CCCC","#00EEEE","#33FFFF","#77FFFF","#AAFFFF"],
  // 🩵 Sky Blues
  ["#000D1A","#001429","#001F3F","#003366","#005599","#0077CC","#1199EE","#33AAFF","#55BBFF","#88CCFF","#BBDDFF","#DDEEFF"],
  // 💙 Blues
  ["#00001A","#00002E","#000044","#000077","#0000AA","#0000DD","#2222FF","#5555FF","#7777FF","#9999FF","#BBBBFF","#DDDDFF"],
  // 🟣 Indigos / Blue-Purples
  ["#050014","#0A0029","#0D0033","#1A0066","#2E0099","#4400CC","#5500EE","#6611FF","#8844FF","#AA77FF","#CCAAFF","#EEDDFF"],
  // 💜 Purples / Violets
  ["#0E0014","#180022","#220033","#440066","#660099","#8800BB","#AA00CC","#BB11DD","#CC33EE","#DD66FF","#EE99FF","#FFCCFF"],
  // 🩷 Magentas / Hot Pinks
  ["#14000E","#220016","#330022","#660044","#990066","#BB0088","#DD00AA","#FF00CC","#FF33DD","#FF66EE","#FF99F5","#FFCCFF"],
  // 🌸 Pinks / Rose
  ["#1A000D","#2B0016","#440022","#770044","#AA0055","#CC2266","#EE4488","#FF55AA","#FF77BB","#FF99CC","#FFBBDD","#FFDDEE"],
  // 🤎 Browns / Earth
  ["#0A0300","#140600","#1A0800","#3D1500","#6B2D00","#8B4513","#A0522D","#BC6C25","#D4935A","#E8B48A","#F5D0B0","#FFF0E8"],
  // ⬛⬜ Blacks, Greys & White

...
export function OutputNode({ data, selected }) {
  return (
    <div
      className={`relative rounded-2xl border overflow-hidden transition-all duration-200 min-w-[180px] ${STATUS_RING[data.status || 'idle']} ${selected ? 'ring-2 ring-[#4ECDC4]/60' : ''}`}
      style={{ backgroundColor: '#111111' }}
    >

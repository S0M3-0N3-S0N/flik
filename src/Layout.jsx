...
import { Sparkles, Image, Wand2, Settings, Sun, Moon, User, Menu, X, ArrowLeft, Video } from "lucide-react";
  ...
  return (
    <LanguageContext.Provider value={{ language, setLanguage, t }}>
      <div className={`min-h-screen bg-[#0A0A0A] text-white transition-all duration-300 overflow-x-hidden ${!isDarkMode ? 'light-mode-theme' : ''}`}>
        ...
        <nav className="hidden md:flex fixed top-0 left-0 right-0 z-50 border-b border-white/5 backdrop-blur-xl" style={{ paddingTop: 'env(safe-area-inset-top)' }}>

...
import { Sparkles, Image, Wand2, Settings, Sun, Moon, User, Menu, X, ArrowLeft, Video, Camera } from "lucide-react";
  ...
  return (
    <LanguageContext.Provider value={{ language, setLanguage, t }}>
      <div className={`min-h-screen bg-[#0A0A0A] text-white transition-all duration-300 overflow-x-hidden ${!isDarkMode ? 'light-mode-theme' : ''}`}>
        ...
        <nav className="fixed top-0 left-0 right-0 z-50 glass-card border-b border-white/5 backdrop-blur-xl hidden md:flex" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
